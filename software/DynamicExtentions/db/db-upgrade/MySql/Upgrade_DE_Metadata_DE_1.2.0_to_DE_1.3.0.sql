...
DYEXTN_PERMISSIBLE_VALUE add index FK136264E0668894B9 (SKIP_LOGIC_CAT_ATTR_ID), add constraint FK136264E0668894B9 foreign key (SKIP_LOGIC_CAT_ATTR_ID) references DYEXTN_CATEGORY_ATTRIBUTE (IDENTIFIER);
