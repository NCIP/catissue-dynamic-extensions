...
create table DYEXTN_ABSTRACT_FORM_CONTEXT (IDENTIFIER bigint not null auto_increment, FORM_LABEL varchar(255), CONTAINER_ID bigint, ACTIVITY_STATUS varchar(10), primary key (IDENTIFIER));
...
create table DYEXTN_ABSTRACT_RECORD_ENTRY (IDENTIFIER bigint not null auto_increment, ACTIVITY_STATUS varchar(10), ABSTRACT_FORM_CONTEXT_ID bigint, primary key (IDENTIFIER));
...
create table DYEXTN_COLUMN_PROPERTIES (IDENTIFIER bigint not null, CATEGORY_ATTRIBUTE_ID bigint, PRIMITIVE_ATTRIBUTE_ID bigint, CNSTR_KEY_PROP_ID bigint, primary key (IDENTIFIER));
...
create table DYEXTN_CONSTRAINT_PROPERTIES (IDENTIFIER bigint not null, CONSTRAINT_NAME varchar(255), CATEGORY_ASSOCIATION_ID bigint, ASSOCIATION_ID bigint, ABSTRACT_ENTITY_ID bigint, primary key (IDENTIFIER));
...
create table DYEXTN_RULE (IDENTIFIER bigint not null auto_increment, NAME varchar(255), IS_IMPLICIT bit, CATEGORY_ATTR_ID bigint, ATTRIBUTE_ID bigint, primary key (IDENTIFIER));
