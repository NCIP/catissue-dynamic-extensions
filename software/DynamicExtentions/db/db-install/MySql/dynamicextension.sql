...
create table ABSTRACT_CATEGORIAL_ATTRIBUTE (ID bigint not null auto_increment, CATEGORIAL_CLASS_ID bigint, DE_SOURCE_CLASS_ATTRIBUTE_ID bigint, ABSTRACT_CATEGORIAL_ATTRIBUTE_ID bigint, primary key (ID));
...
create table DYEXTN_FORM_CONTEXT (IDENTIFIER bigint not null auto_increment, IS_INFINITE_ENTRY bit, ENTITY_MAP_ID bigint, STUDY_FORM_LABEL varchar(255), NO_OF_ENTRIES integer, primary key (IDENTIFIER));
