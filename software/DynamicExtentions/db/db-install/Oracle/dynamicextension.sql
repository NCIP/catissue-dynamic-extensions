...
create table DYEXTN_ABSTRACT_FORM_CONTEXT (IDENTIFIER number(19,0) not null, FORM_LABEL varchar2(255 char), CONTAINER_ID number(19,0), ACTIVITY_STATUS varchar2(10 char), HIDE_FORM number(1,0), primary key (IDENTIFIER));
...
create table DYEXTN_ABSTRACT_RECORD_ENTRY (IDENTIFIER number(19,0) not null, ACTIVITY_STATUS varchar2(10 char), ABSTRACT_FORM_CONTEXT_ID number(19,0), MODIFIED_DATE date, MODIFIED_BY varchar2(255 char), primary key (IDENTIFIER));
