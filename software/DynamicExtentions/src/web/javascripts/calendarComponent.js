...
//  document.write('<form>');
    ...
    document.write('<tr>');
    document.write('    <td class="CALENDARBORDER" width="1"></td>');
    ...
    document.write('    <td class="CALENDRIER" width="50"><img src="' + imgsrc + 'calBackground.gif" width=1 height=1></td>');
    document.write('    <td class="CALENDRIER" width="10">'+"  " + computedcaldays[1] + '</td>');
    document.write('    <td class="CALENDRIER" width="1"><img src="' + imgsrc + 'calBackground.gif" width=1 height=1></td>');
