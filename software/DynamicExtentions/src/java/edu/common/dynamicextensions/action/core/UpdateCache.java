...
public class UpdateCache extends HttpServlet
{
	 ...
	 */
	public void releaseEntity(Map<String, Object> paramaterObjectMap)
	{
	 ...
	 */
	public void lockEntity(Map<String, Object> paramaterObjectMap)
	 ...
	 * @throws DynamicExtensionsSystemException the dynamic extensions system exception
	 */
	public void relaseForms(Map<String, Object> paramaterObjectMap)
			throws DynamicExtensionsSystemException
	{
		EntityGroupInterface entityGroupInterface = EntityCache.getInstance().getEntityGroupByName(
				(String) paramaterObjectMap.get(WebUIManagerConstants.ENTITY_GROUP));
	 ...
	 * @throws DynamicExtensionsSystemException the dynamic extensions system exception
	 */
	public void lockForms(Map<String, Object> paramaterObjectMap)
			throws DynamicExtensionsSystemException
	{
		EntityGroupInterface entityGroupInterface = EntityCache.getInstance().getEntityGroupByName(
				(String) paramaterObjectMap.get(WebUIManagerConstants.ENTITY_GROUP));
	 ...
	 */
	public void updateCache(Map<String, Object> paramaterObjectMap)
...
//			dao.commit();
//			LOGGER.info("UpdateCache :: refreshCache :: Closing Hibernate");
//			dao.closeSession();
//		}
