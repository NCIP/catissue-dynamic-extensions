 ...
 *
 */
public abstract class AbstractBaseMetadataManager implements
        ...
        DynamicExtensionsQueryBuilderConstantsInterface
{
     ...
     */
    protected final transient AbstractMetadataManagerHelper
    abstractMetadataManagerHelper = AbstractMetadataManagerHelper
            .getInstance();
    ...
    protected void rollbackQueries(Stack<String> revQryStack,
            ...
            DAO dao) throws DynamicExtensionsSystemException
    {
    ...
    {
        Logger.out.debug("[AbstractMetadataManager.]" + methodName + "() -- "
                + message);
    }
     ...
     */
    protected Collection getAllObjects(String objectName)
            throws DynamicExtensionsSystemException,
     ...
     *             the dynamic extensions application exception
     */
    protected DynamicExtensionBaseDomainObject getObjectByIdentifier(
    ...
    protected Collection executeHQL(String queryName,
            Map<String, NamedQueryParam> substParams)
            throws DynamicExtensionsSystemException
    {
        Collection objects = null;
        ...
        {
            throw new DynamicExtensionsSystemException(
                    "Error while rolling back the session", e);
        }
        finally
        {
     ...
     */
    protected Object setObjectProperty(AbstractAttribute attribute,
            String dataType, Class klass,
            Map<AbstractAttributeInterface, Object> dataValue,
            Object returnedObj) throws ClassNotFoundException, ParseException,
            ...
            InvocationTargetException
    {
        ...
        abstractMetadataManagerHelper.handleDatatype(attribute, dataType,
                klass, returnedObj, value, attrName);
        return returnedObj;
    }
     ...
     */
    protected Object setObjectProperty(AbstractAttribute attribute,
            String dataType, Class klass, Object walue, Object returnedObj)
     ...
     *             the no such method exception
     */
    protected void invokeSetterMethod(Class klass, String property,
...

    {
        ...
        abstractMetadataManagerHelper.invokeSetterMethod(klass, property,
                argumentType, invokeOnObject, argument);
    }
     ...
     *             the illegal access exception
     */
    protected Object invokeGetterMethod(Class klass, String property,
            Object invokeOnObject) throws NoSuchMethodException,
     ...
     *             the dynamic extensions system exception
     */
    public DynamicExtensionBaseDomainObjectInterface getObjectByName(
            ...
            throws DynamicExtensionsSystemException
    {
        ...
        if (abstractMetadataManagerHelper.isNotEmptyString(objectName))
        {
            ...
            try
            {
                List objects = defaultBizLogic.retrieve(className, "name",
                        objectName);
                if (objects != null && !objects.isEmpty())
                {
                    dyExtBsDmnObj = (DynamicExtensionBaseDomainObjectInterface) objects
                            .get(0);
                }
            }
            catch (BizLogicException e)
     ...
     */
    public DynamicExtensionBaseDomainObjectInterface getObjectByName(
            String className, String objectName, HibernateDAO hibernateDao)
            throws DynamicExtensionsSystemException
    {
        DynamicExtensionBaseDomainObjectInterface dyExtBsDmnObj = null;
        if (abstractMetadataManagerHelper.isNotEmptyString(objectName))
        {
            try
            {
                List objects = hibernateDao.retrieve(className, "name",
                        objectName);
                if (objects != null && !objects.isEmpty())
                {
                    dyExtBsDmnObj = (DynamicExtensionBaseDomainObjectInterface) objects
