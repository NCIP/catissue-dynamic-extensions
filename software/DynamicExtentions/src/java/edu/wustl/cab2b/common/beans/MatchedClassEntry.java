...
public class MatchedClassEntry implements Serializable
{
	...
	private final Map<MatchCause, Integer> causeVsPosition = new HashMap<MatchCause, Integer>();
	...
	public boolean equals(Object other)
	{
		...
		return matchedEntity.equals(otherEntry.matchedEntity);
	}
	...
	public enum MatchCause {
		EntityName, EntityDescription, EntitySemanticProperty, AttributeName, AttributeDescription, AttributeSemanticProperty, PermissibleValueName, PermissibleSemanticProperty;
	}
}
