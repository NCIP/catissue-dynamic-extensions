...
public class UtilityTest extends DynamicExtensionsBaseTestCase {
	...
	public void testGetDisplayNameFE() {
		...
		entity.getEntityGroup().setLongName("caFE Server 1.1");
		entity.getEntityGroup().setVersion("1.1");
		String res = Utility.getDisplayName(entity);
